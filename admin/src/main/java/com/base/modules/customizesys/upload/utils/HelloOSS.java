...
public class HelloOSS {
    ...
    public static void main(String[] args) {
    	...
    	HelloOSS helloOSS =new HelloOSS();
    	helloOSS.logger.info("Started");
        ...
        try {
            ...
            String objectName="amd";//类似于目录，不存在会自动创建
            String pathName= UUIDUtils.getRandomUUID()+".jpg";
            ossClient.putObject(bucketName,objectName+"/"+pathName, new File("C:/Users/huanw/Desktop/0.jpg"));
            System.out.println("Object：" + objectName+"/"+pathName + "存入OSS成功。");
...
//
//            GeneratePresignedUrlRequest generatePresignedUrlRequest =new GeneratePresignedUrlRequest(bucketName,  path+"/"+pathName+".jpg");
//
//            generatePresignedUrlRequest.setExpiration(expires);
//
//            URL url = ossClient.generatePresignedUrl(generatePresignedUrlRequest);
            String url="https://aimaodou.oss-cn-beijing.aliyuncs.com/amd/"+pathName;
...
//            ossClient.getObject(new GetObjectRequest(bucketName, objectName+"/"+pathName),new File("C:/Users/huanw/Desktop/22222.jpg"));
//            System.out.println("Object：" + path+"/"+pathName+".jpg" + "的内容是：");
//            
//            
...
////            // 链接地址是：https://help.aliyun.com/document_detail/oss/sdk/java-sdk/manage_object.html?spm=5176.docoss/sdk/java-sdk/manage_bucket
//            ossClient.deleteObject(bucketName, "files/0.jpg");
//            System.out.println("删除Object：" + "files/0.jpg" + "成功。");
////            ossClient.deleteObject(bucketName, "files/0.jpg");
////            System.out.println("删除Object：" + fileKey + "成功。");
        ...
        helloOSS.logger.info("Completed");
    }
