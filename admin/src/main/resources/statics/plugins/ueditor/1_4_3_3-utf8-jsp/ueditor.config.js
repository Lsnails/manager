...
//	var URL = "/admin/statics/plugins/ueditor/1_4_3_3-utf8-jsp/"
    /**
...
//        , serverUrl: URL + "jsp/controller.jsp"
        , serverUrl: proName+"/upload/config" //通过后台读取config.json文件
    	...
    	, toolbars: [[
            ...
            'simpleupload', 'insertimage',   'insertvideo', 'music', 'attachment', 'map',  'pagebreak', 'template', 'background', '|',
